        ...
        this.themes = {
            light: {
                ...
                colors: {
                    ...
                    '--accent-primary': '#8B4049',
                    '--accent-secondary': '#722f37',
                    '--border-color': '#E5E5E5',
                    '--hover-bg': '#f5f5f7',
            ...
            dark: {
                ...
                colors: {
                    ...
                    '--accent-primary': '#A84C49',
                    '--accent-secondary': '#C05B57',
                    '--border-color': '#2A2A2A',
                    '--hover-bg': '#2A2A2A',
            ...
            sepia: {
                ...
                colors: {
                    ...
                    '--border-color': '#D4C4A8',
                    '--hover-bg': '#e8dcc4',
                    '--shadow': 'rgba(92, 74, 58, 0.12)',
                    '--card-bg': '#F9F3E3',
                    '--card-shadow': '0 2px 8px rgba(92, 74, 58, 0.12)',
                    '--card-radius': '12px',
                    '--button-radius': '20px'
                }
            }
